...
% Corpus, Installed Skills, the built-in skill-creator).  SkillRouter is the
% single skill-MCP entry point: every skill tool is labelled on the router
% operation it drives.
...
% ============================ DSAgt stores ==============================
\node[store, minimum width=34mm] (corpus) at (5.6,0.6)
  {\textbf{Skills Corpus}\\{\scriptsize federated across sources}\\{\scriptsize searchable $\cdot$ not yet installed}};
...
\node[anchor=north, align=center, font=\footnotesize]
  ...
  {\textbf{Installed Skills}\\{\scriptsize installed + created}\\{\scriptsize .claude $\cdot$ .agents $\cdot$ .cline $\cdot$ .roo /skills}};
...
\draw[bilink] (router.south) -- (corpus.north)

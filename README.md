...
**Prerequisites:** Python 3.12 or 3.13 on Apple Silicon or Linux x86_64 (torch has no NumPy 2 wheel for Intel Macs), and one of the supported agent platforms below — already installed and authenticated against whatever LLM provider you intend to use.
